...
export function interactiveTypeSysUser(query) {
  return request({
    url: '/warmFlow/execute/interactiveTypeSysUser',
    method: 'post',
    data: { ...query, ...query.params, params: undefined },
  });
}
// 查询用户列表
...
export function findByDepartmentFunction(data) {
  return request({
    url: '/erpMaster/departmentFunction/findByDepartmentFunction',
    method: 'post',
    data,
  });
}
