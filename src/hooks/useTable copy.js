 ...
 * @LastEditTime: 2024-08-21 15:11:50
 * @Description: 页面操作方法封装
 */
...
export const useTable = (
  ...
  const getTableList = async () => {
    ...
    try {
      ...
      const tableData = isPageable ? data?.records || [] : data || [];
