...
const colors = reactive({
  bgTop: '#f1f5f9', // 工业风浅灰蓝顶色
  bgBottom: '#e2e8f0', // 工业风浅灰蓝底色
  bgStripe: 'rgba(15, 23, 42, 0.05)', // 细微斜向纹理
  text: '#1f2937', // 文本文字色（标注/提示）
  labelStroke: 'rgba(255,255,255,0.8)', // 文字浅描边，提升对比度
  gridFine: '#d6dde6', // 细网格
  gridCoarse: '#b9c4d2', // 粗网格
  polygonStroke: '#0f4c81', // 多边形描边（工业蓝）
  polygonFill: '#0f4c81', // 多边形填充（工业蓝）
});
