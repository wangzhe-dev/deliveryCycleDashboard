 ...
 * @LastEditTime: 2024-01-17 18:40:52
 * @Description: 销售订单
-->
<template>
  <div class="w-full">
...
<script setup lang="jsx" name="SaleOrderHeaderModal">
import { checkCode } from './services';
import SaleOrderHeaderDialog from '@/components/SaleOrderHeaderDialog/index';
