...
<script setup lang="jsx" name="PurchaseReqOrderListModal">
import { checkCode } from './services';
import PurchaseReqOrderListDialog from '@/components/PurchaseReqOrderListDialog/index';
