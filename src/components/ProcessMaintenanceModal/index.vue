...
<script setup lang="jsx" name="ProcessMaintenanceModal">
import { checkCode } from './services';
import ProcessMaintenanceDialog from '@/components/ProcessMaintenanceDialog/index';
