...
import { scaleList, getBeginTimeOfTimeLine, calcScalesAbout2Times } from './utils/timeLineUtils.js';
...
export default {
  ...
  methods: {
    ...
    getTimeRange() {
      ...
      let { beginTimeOfTimeLine, scrollLeft, cellWidth, scale, widthOfRenderAera } = this;
    ...
    syncScrollX(event, fake = false) {
      let { gantt_table, gantt_timeline, gantt_markArea, gantt_scroll_x } = this.selector;
