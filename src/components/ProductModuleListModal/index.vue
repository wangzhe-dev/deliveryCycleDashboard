 ...
 * @LastEditTime: 2023-09-25 10:52:39
...
<script setup lang="jsx" name="ProductModuleListModal">
import { checkCode } from './services';
import ProductModuleListDialog from '@/components/ProductModuleListDialog/index';
