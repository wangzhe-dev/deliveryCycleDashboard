...
<script setup lang="jsx" name="OutComponentListModal">
import { checkCode } from './services';
import OutComponentListDialog from '@/components/OutComponentListDialog/index';
